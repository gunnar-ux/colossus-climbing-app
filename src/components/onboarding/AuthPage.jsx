  ...
  return (
    <div className="min-h-screen-mobile flex flex-col items-center justify-center px-6 pt-safe-top pb-safe-bottom bg-bg">
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        {/* Apple Sign In - Non-functional placeholder */}
        <button 
          disabled
          className="w-full min-h-[52px] py-4 rounded-col font-semibold transition bg-card border border-border text-white/40 cursor-not-allowed flex items-center justify-center gap-3"
        >
